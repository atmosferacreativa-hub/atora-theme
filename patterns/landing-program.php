...
<h1 style="font-family: var(--as-font-serif); font-size: 54px; font-weight: 700; letter-spacing: -0.02em; margin: 24px auto; max-width: 900px;">Programa de Fotografia Profesional</h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","style":{"fontSize":"17px","lineHeight":"1.65","maxWidth":"600px","marginLeft":"auto","marginRight":"auto"}} -->
<p style="font-size: 17px; line-height: 1.65; max-width: 600px; margin: 24px auto;">Programa de 18 semanas diseñado para fotografos y equipos creativos que buscan consolidar una carrera profesional en fotografia comercial, publicitaria y documental.</p>
<!-- /wp:paragraph -->

<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
<div class="wp-block-buttons"><!-- wp:button {"style":{"typography":{"fontWeight":"700"}}} -->
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" style="font-weight: 700;">Inscribirse ahora</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->
...
<!-- wp:heading {"level":3,"style":{"typography":{"fontFamily":"var(--as-font-serif)","fontSize":"24px"}}} -->
<h3 style="font-family: var(--as-font-serif); font-size: 24px; margin-top: 0;">Fundamentos de luz</h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Aprende la teoria de la luz natural y artificial, metering y tecnicas de iluminacion aplicadas a estudio.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"fontSize":"13px","color":"var(--as-muted)","marginTop":"16px"}} -->
<p style="font-size: 13px; color: var(--as-muted); margin-top: 16px;"><strong>Sem 1-3</strong> · 9 lecciones</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:heading {"level":3,"style":{"typography":{"fontFamily":"var(--as-font-serif)","fontSize":"24px"}}} -->
<h3 style="font-family: var(--as-font-serif); font-size: 24px; margin-top: 0;">Composición y narrativa</h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Técnicas de composición visual, narrativa fotográfica y construcción de series temáticas.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"fontSize":"13px","color":"var(--as-muted)","marginTop":"16px"}} -->
<p style="font-size: 13px; color: var(--as-muted); margin-top: 16px;"><strong>Sem 4-6</strong> · 8 lecciones</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:heading {"level":3,"style":{"typography":{"fontFamily":"var(--as-font-serif)","fontSize":"24px"}}} -->
<h3 style="font-family: var(--as-font-serif); font-size: 24px; margin-top: 0;">Postproducción profesional</h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Edicion en Adobe Lightroom y Photoshop, manejo de color y creacion de estilos visuales coherentes.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"fontSize":"13px","color":"var(--as-muted)","marginTop":"16px"}} -->
<p style="font-size: 13px; color: var(--as-muted); margin-top: 16px;"><strong>Sem 7-9</strong> · 10 lecciones</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:heading {"level":3,"style":{"typography":{"fontFamily":"var(--as-font-serif)","fontSize":"24px"}}} -->
<h3 style="font-family: var(--as-font-serif); font-size: 24px; margin-top: 0;">Fotografía especializada</h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Aplicaciones: comercial, publicitaria, documental, fotografia de viaje y eventos.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"fontSize":"13px","color":"var(--as-muted)","marginTop":"16px"}} -->
<p style="font-size: 13px; color: var(--as-muted); margin-top: 16px;"><strong>Sem 10-14</strong> · 12 lecciones</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:heading {"level":3,"style":{"typography":{"fontFamily":"var(--as-font-serif)","fontSize":"24px"}}} -->
<h3 style="font-family: var(--as-font-serif); font-size: 24px; margin-top: 0;">Proyecto final y portafolio comercial</h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Desarrollo de proyecto capstone, construccion de portafolio profesional y estrategia de comercializacion.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"fontSize":"13px","color":"var(--as-muted)","marginTop":"16px"}} -->
<p style="font-size: 13px; color: var(--as-muted); margin-top: 16px;"><strong>Sem 15-18</strong> · 6 lecciones + mentoring</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->

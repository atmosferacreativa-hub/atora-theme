...
<h1 style="font-family: var(--as-font-serif); font-size: 56px; font-weight: 700; letter-spacing: -0.02em;">Hablemos de tu próximo paso</h1>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"style":{"color":"var(--as-muted)","fontSize":"14px","marginTop":"12px"}} -->
<p style="color: var(--as-muted); font-size: 14px; margin-top: 12px;">Respuesta dentro de 24 horas</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"fontWeight":"700","fontSize":"15px","marginTop":"16px"}} -->
<p style="font-weight: 700; font-size: 15px; margin-top: 16px;"><a href="mailto:hola@atora.studio">hola@atora.studio</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"style":{"color":"var(--as-muted)","fontSize":"14px","marginTop":"12px"}} -->
<p style="color: var(--as-muted); font-size: 14px; margin-top: 12px;">Chat instantáneo para consultas rápidas</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"style":{"color":"var(--as-muted)","fontSize":"14px","marginTop":"12px"}} -->
<p style="color: var(--as-muted); font-size: 14px; margin-top: 12px;">Videollamada privada de 30 minutos</p>
<!-- /wp:paragraph -->

<!-- wp:buttons {"style":{"margin":{"top":"16px"}}} -->
<div class="wp-block-buttons" style="margin-top: 16px;"><!-- wp:button {"className":"is-style-outline","style":{"typography":{"fontWeight":"700"}}} -->
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" style="font-weight: 700;">Agendar llamada</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"style":{"fontSize":"14px","color":"var(--as-muted)","marginTop":"12px"}} -->
